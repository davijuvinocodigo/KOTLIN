...
import com.dio.credit_application.dto.CreditDTO
import com.dio.credit_application.dto.CreditView
import com.dio.credit_application.dto.CreditViewList
import com.dio.credit_application.entity.Credit
import com.dio.credit_application.service.impl.CreditService
...
class CreditController(
    ...
    fun saveCredit(@RequestBody creditDTO: CreditDTO): ResponseEntity<String> {
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
            .body("Credit with id ${creditSaved.id} saved successfully")
    }
